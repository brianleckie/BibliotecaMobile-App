...
export default function Catalogo() {
  ...
  useEffect(() => {
    setPage(1);
  }, [debouncedBusqueda, soloDisponibles, categoriaId]);
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: 'var(--bg)' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', minHeight: 0 }}>
        ...
        <div style={{
          ...
          padding: categorias.length > 0 ? '4px 16px 12px' : '14px 16px 12px',
        }}>
          ...
          >
            ...
            <span style={{
              ...
              display: 'flex',
              justifyContent: soloDisponibles ? 'flex-end' : 'flex-start',
            }}>
              <span style={{
            ...
            libros.map(libro => {
              ...
              return (
                <button
                  ...
                  style={{
                    display: 'flex', gap: 13, textAlign: 'left', cursor: 'pointer',
                    background: 'var(--surface)', border: '1px solid var(--border)',
                    borderRadius: 14, padding: 11,
                  }}
                >
                  <Cover bookId={libro.id} available={disp} h={92} w={68} radius={7} />
                  <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 5, paddingTop: 2 }}>
                    ...
                    <div style={{ marginTop: 'auto', paddingTop: 4 }}>
                      {disp
                        ? <Badge kind="ok">{libro.copias_disponibles} disponible{libro.copias_disponibles !== 1 ? 's' : ''}</Badge>
                        : <Badge kind="no">Prestado</Badge>
                      }
                    </div>
                  </div>
